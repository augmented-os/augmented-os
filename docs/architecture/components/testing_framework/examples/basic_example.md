# Testing Framework Basic Examples

This document provides basic examples of using the Testing Framework for common testing scenarios.
...

{
  ...
  "test_script": {
    "inputs": {
      ...
      "subject": "Test Email",
      "body": "This is a test email from the Testing Framework."
    },
    "assertions": [
      {
        "type": "status",
